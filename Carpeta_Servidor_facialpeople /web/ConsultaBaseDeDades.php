...
<div><table width="440" height="339" border="1">
  <tr>
    <th width="153" height="67" scope="row"><div><img src="<?php echo $row['<img name="id_imagen" src="" width="32" height="32" alt="" />'] ?>" width="138" height="101" alt="" /></div></th>
    <td width="271"><table width="271" height="108" border="1">
      ...
      <tr>
        ...
        <th scope="row"><div>
          <div align="left"><?php echo $row['NOM'] ?></div>
        </div></th>
      </tr>
    </table></td>
  </tr>
