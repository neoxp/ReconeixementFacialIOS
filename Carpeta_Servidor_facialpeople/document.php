...
<div><table width="440" height="339" border="1">
  <tr>
    <th width="153" height="67" scope="row"><div><img src="<?php
    
    $link = mysqli_connect("mysql.webcindario.com", "facialpeople", "admin1234");
    or die ("Error al conectar a la base de datos.");
    @mysql_select_db("facialpeople", $link)
    or die ("Error al conectar a la base de datos.");
    
    $query = "SELECT image_id FROM `RECONEIXEMENT FACIAL` WHERE id = id";
    $result = mysql_query($query);
    $numero = 0;
    while($row = mysql_fetch_array($result))
    {
        echo "<tr><td width=\"25%\"><"img src=">" .
	    $row["image_id"] . "</font></td>";
        $numero++;
    }
    ...
    mysql_cl ?>" width="138" height="101" alt="" /></div></th>
    <td width="271"><table width="271" height="108" border="1">
      <tr>
